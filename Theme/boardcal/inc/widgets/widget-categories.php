 ...
 * boardcal Theme
 */
class boardcal_categories extends WP_Widget
{
	 function boardcal_categories(){

        $widget_ops = array('classname' => 'boardcal-cats','description' => esc_html__( "boardcal widget to display categories" ,'boardcal') );
		    parent::__construct('boardcal-cats', esc_html__('boardcal Categories','boardcal'), $widget_ops);
    }

    function widget($args , $instance) {
    	extract($args);
        $title = isset($instance['title']) ? esc_html( $instance['title'] ) : esc_html__('Categories' , 'boardcal');
        $enable_count = '';
    ...
    function form($instance) {
      if(!isset($instance['title'])) $instance['title'] = esc_html__('Categories' , 'boardcal');
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"> <?php esc_html_e('Limit Categories ','boardcal') ?></label>
      ...
      <p><label>
        <input  type="checkbox"
         ...
         />
         <?php esc_html_e('Enable Posts Count','boardcal') ?></label>
       </p>
